          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <span className={`text-sm font-medium ${
                theme === 'light' ? 'text-primary-700' : 'text-gray-700'
              }`}>
                Light
              </span>
            </button>
            ...
            >
              ...
              <span className={`text-sm font-medium ${
                theme === 'dark' ? 'text-primary-700' : 'text-gray-700'
              }`}>
                Dark
              </span>
            </button>
            ...
            >
              ...
              <span className={`text-sm font-medium ${
                theme === 'system' ? 'text-primary-700' : 'text-gray-700'
              }`}>
                System
              </span>
            </button>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              ...
              <select className="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-primary-500 sm:text-sm">
      ...
      <Card className="border-error-200 dark:border-error-800">
        ...
        <CardContent>
          <div className="flex items-center justify-between p-4 bg-error-50 dark:bg-error-900/20 rounded-lg">
            <div className="flex items-center space-x-3">
              <TrashIcon className="h-5 w-5 text-error-600" />
              <div>
                <h4 className="font-medium text-error-700 dark:text-error-300">Delete Account</h4>
